  ...
  return (
    ...
    >
      <header className="flex items-center justify-between">
        <div>
          <h2 className="text-4xl font-bold text-gray-900 tracking-tight mb-2">แดชบอร์ด</h2>
          <p className="text-gray-500">ยินดีต้อนรับกลับมา นี่คือสิ่งที่เกิดขึ้นในวันนี้</p>
        </div>
        ...
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
          ...
          <div className="space-y-4">
            {students.slice(0, 5).map((student) => {
              ...
              return (
                <div key={student.id} className="flex items-center justify-between p-4 rounded-2xl bg-page-bg">
